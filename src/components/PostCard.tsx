...
export function PostCard({ post }: { post: PostRow }) {
  return (
    <div className="flex gap-3 rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md dark:border-neutral-800 dark:bg-neutral-900">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-2.5 flex items-center gap-3 text-xs">
          <Link
            href={`/post/${post.id}`}
            className="inline-flex items-center gap-1 rounded-full bg-neutral-100 px-2.5 py-1 font-medium text-neutral-600 hover:bg-neutral-200 dark:bg-neutral-800 dark:text-neutral-300 dark:hover:bg-neutral-700"
          >
            💬 {post.comment_count}
          </Link>
        </div>
